...
class CNSFileConfig(VapiStruct):
    ...
    def __init__(self,
        ...
        :param vsan_clusters: :attr:`CNSFileConfig.vsan_clusters` is a list of clusters to be
            used for provisioning file volumes. As a prerequisite these
            clusters must have vSAN and vSAN file services enabled, and must be
            in the same vCenter as the Supervisor Cluster. Currently this list
            must have a single entry which is the cluster identifier of the
            current cluster. This cluster must be a vSAN cluster and must have
            vSAN File Service enabled. If a cluster in the list is not a vSAN
            cluster or does not have vSAN File Service enabled, an
            InvalidArgument error will be thrown from ``Clusters.enable``,
            ``Clusters.update`` and ``Clusters.set`` APIs. For disabling file
            volume support on Supervisor Cluster, an empty list is expected.
...
class Clusters(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param cns_file_config: Specification for configuring Cloud Native Storage file volume
                support on Supervisor Cluster. This feature provides support for
    ...
    class EnableSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param cns_file_config: Specification for configuring Cloud Native Storage file volume
                ...
                and/or external clusters. This attribute was added in vSphere API
                7.0.3.0.
                If None, file volume support will not be enabled on this Supervisor
                Cluster.
            :type  login_banner: :class:`str` or ``None``
            :param login_banner: Disclaimer to be displayed prior to login via the Kubectl plugin.
                If None, just skip it.
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param floating_ip: Optionally, you can edit the floating IP address that is assigned
                to the Supervisor Cluster in case the DHCP server fails during the
                Supervisor Cluster enablement process. The field is only relevant
                when the DHCP mode of the Supervisor Cluster management network is
                set with
                com.vmware.vcenter.namespace_management.EnableSpec#masterManagementNetwork.
    ...
    def set(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            if the user does not have Namespaces.Manage privilege.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            if the cluster's hosts are not configured with sufficient resources
            for the new Kubernetes API Server size.
        """
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nsx_network: The create spec for a NSXT-backed Namespaces network configuration,
                supported by ``NSXT_CONTAINER_PLUGIN`` network provider. This
                attribute was added in vSphere API 7.0.2.0.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
                :attr:`Clusters.NetworkProvider.NSXT_CONTAINER_PLUGIN`.
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nsx_network: Modified configuration specification for a NSXT-backed Namespaces
                network configuration, supported by ``NSXT_CONTAINER_PLUGIN``
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nsx_network: Configuration specification for a NSXT-backed Namespaces network
                configuration, supported by ``NSXT_CONTAINER_PLUGIN`` network
...
class SupervisorServices(VapiInterface):
    ...
    Supervisor clusters and provide services to applications running in vSphere
    Supervisor clusters. They are often provided by 3rd party vendors. This
    class was added in vSphere API 7.0.3.0.
    """
    ...
    class CreateSpec(VapiStruct):
        ...
        required to create a Supervisor Service. This class was added in vSphere
        API 7.0.3.0.
        ...
        def __init__(self,
            ...
            :param custom_spec: The specification required to create a Supervisor Service with a
                version from inline content that is not based on the vSphere
                application service format, instead a plain Kubernetes YAML format.
                
                Exactly one of ``customSpec`` or ``vsphereSpec`` must be
                :class:`set`.. This attribute was added in vSphere API 7.0.3.0.
    ...
    class CustomCreateSpec(VapiStruct):
        ...
        required to create a Supervisor Service with a version from a custom format
        that doesn't follow the vSphere application service format, just like any
        custom operator. This class was added in vSphere API 7.0.3.0.
    ...
    class CheckResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param content_type: The type of the provided content. When this ``contentType`` is
                ``ContentType#CUSTOM_YAML``, the ``status`` is always ``VALID``
                because a custom format is not validated. This attribute was added
                in vSphere API 7.0.3.0.
            ...
            :param vsphere_apps_check_result: The information about the Supervisor Service version retrieved from
                ...
                content is in the vSphere application service format. This
                attribute was added in vSphere API 7.0.3.0.
    ...
    def check_content(self,
        ...
        ``VALID`` status. Only vSphere applications validation can return
        multiple status. This method was added in vSphere API 7.0.3.0.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            ``ContentCheckSpec#content`` is empty or not base64 encoded.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user cannot be authenticated.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
    ...
    def delete(self,
        ...
        vCenter. Note that the ``SupervisorService#deactivate`` method should
        be called to deactivate the Supervisor Service before the Supervisor
        Service can be deleted. This method was added in vSphere API 7.0.3.0.

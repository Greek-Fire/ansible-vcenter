...
the vSphere Supervisor clusters.
...
class ClusterSupervisorServices(VapiInterface):
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supervisor_service: Identifier of the Supervisor Service. This Supervisor Service must
                be in the ``State#ACTIVATED`` state. This attribute was added in
                vSphere API 7.0.3.0.
            ...
            :param version: Identifier of the Supervisor Service version which contains the
                ...
                ``State#ACTIVATED`` state. This attribute was added in vSphere API
                7.0.3.0.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    class SetSpec(VapiStruct):
        ...
        current specification fully. This class was added in vSphere API 7.0.3.0.
    ...
    def create(self,
        ...
        """
        Create a Supervisor Service on the specified vSphere Supervisor
        cluster. This method will apply the Supervisor Service version's
        ...
        ``State#ACTIVATED`` state. This method was added in vSphere API
        7.0.3.0.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the Supervisor cluster on which to create the
            service.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.AlreadyExists` 
            if a Supervisor Service with the ID ``supervisorService`` exists on
            the Supervisor cluster
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the specified cluster with ID ``cluster`` or Supervisor Service
            with the ID ``supervisorService`` or version with the ID
            {param.name version} could not be located.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the Supervisor cluster doesn't support Supervisor Services, or
            if the Supervisor Service cannot be created in the current state,
            e.g. the supervisor service version is in the ``State#DEACTIVATED``
            state.
    ...
    def list(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if Supervisor cluster with the ID ``cluster`` could not be located.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if Supervisor cluster with the ID ``cluster`` or the Supervisor
            Service does not exist on the Supervisor cluster.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the Supervisor cluster doesn't support Supervisor Services.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user cannot be authenticated.
    ...
    def delete(self,
        ...
        """
        Delete a Supervisor Service on the specified vSphere Supervisor
        ...
        Service. Note that this operation doesn't deal with the application
        instances that are created by the associated operator(s), so existing
        application instances could be orphaned if users don't clean or migrate
        them. This method was added in vSphere API 7.0.3.0.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the Supervisor cluster from which to delete the
            service.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        :type  supervisor_service: :class:`str`
    ...
    def set(self,
        ...
        Supervisor Service version's service definition to the existing
        ...
        vSphere Supervisor cluster. Note that this operation doesn't interfere
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if ``spec`` contains any errors.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if Supervisor cluster with the ID ``cluster`` or Supervisor Service
            with the ID ``supervisor_service`` or version with the ID
            {param.name version} could not be located, or the Supervisor
            Service does not exist on the Supervisor cluster.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the Supervisor cluster doesn't support Supervisor Services or
            the specified version is not in the ``State#ACTIVATED`` state.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user cannot be authenticated.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            if the user does not have the SupervisorServices.Manage privilege
...
class Versions(VapiInterface):
    ...
    vSphere Supervisor clusters. This class was added in vSphere API 7.0.3.0.
    """
    ...
    class ContentType(Enum):
        ...
        """
        The Supervisor Service version definition is provided as inline YAML
        document that doesn't follow the vSphere application service format, just
    ...
    ContentType._set_values([
        ContentType('VSPHERE_APPS_YAML'),
        ContentType('CUSTOM_YAML'),
    ])
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param custom_spec: The specification required to create a Supervisor Service version
                ...
                service format, instead a plain Kubernetes YAML format. 
    ...
    class CustomCreateSpec(VapiStruct):
        ...
        to create a Supervisor Service version from a custom format that doesn't
        follow the vSphere application service format, just like any custom
        operator. This class was added in vSphere API 7.0.3.0.
        ...
        def __init__(self,
            ...
            """
            :type  version: :class:`str`
            :param version: The identifier of the Supervisor Service version. This must be an
            ...
            :param content: Inline content that contains all service definition of the version,
                which shall be base64 encoded. The service definition here doesn't
    ...
    def delete(self,
        ...
        all vSphere Supervisor clusters. Note that the ``Version#deactivate``

...
class AssociatedTgwGroupConnectionInfoVersion2(VapiStruct):
    ...
    def __init__(self,
        ...
        :param sddc_advertise_route_config: SDDC advertise route configuration with AWS prefix list and other
            region TGW connections.
        :type  state: :class:`str` or ``None``
        :param state: Possible values are: 
...
class ExternalConnectivityConfig(VapiStruct):
    ...
    def __init__(self,
        ...
        :param internet_interface: Configuration for Internet Interface.
        ...
        :param intranet_interface: Configuration for Intranet Interface.
        ...
        :param services_interface: Configuration for Services Interface.
...
class RouteConfig(VapiStruct):
    ...
    def __init__(self,
        ...
        :param aggregation_route_config: Object to set the customer defined routeAggregationConfig path.
...
class SddcTransportNodeInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param reservation_info: CPU and memory reservation info for ESO edge nodes.
        """
        self.links = links
        self.schema = schema
        self.self_ = self_
...
class TransportNodeReservationInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param cpu_reservation: CPU Reservation details of ESO edge nodes.
        :type  memory_reservation: :class:`TransportNodeMemoryReservation` or ``None``
        :param memory_reservation: Memory Reservation details of ESO edge nodes.
        """
